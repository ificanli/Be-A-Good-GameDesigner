...
PUBLIC_ARTICLES = (
    ...
    "05_数值与经济/游戏数值设计方法/数值验证与数据复盘-从离线模型到线上诊断.md",
    "05_数值与经济/游戏数值设计方法/PVP平衡-从场景基准到克制关系.md",
    "05_数值与经济/游戏数值设计方法/匹配与排位-MMR段位组队与等待时间.md",
    "05_数值与经济/游戏数值设计方法/多人协作数值-贡献增益与奖励分配.md",
    "05_数值与经济/游戏数值设计方法/版本成长控制-强度膨胀旧内容与追赶.md",
    "05_数值与经济/游戏数值设计方法/玩家资产迁移-映射补偿对账与回滚.md",
    "05_数值与经济/游戏数值设计方法/商品与礼包定价-价值锚点折扣与购买上限.md",
    "05_数值与经济/游戏数值设计方法/商业化边界-随机付费时间压力与玩家公平.md",
    "05_数值与经济/游戏数值设计方法/数值工作簿设计-输入计算输出与检查.md",
    "05_数值与经济/游戏数值设计方法/配置发布流程-版本灰度监控与回滚.md",
)
